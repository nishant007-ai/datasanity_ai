...
<head>
  ...
  <style>
    body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.4; color: #333; background-color: #f8f9fa; padding: 30px; }
    .container { max-width: 800px; margin: auto; background-color: #fff; padding: 40px; border-radius: 10px; box-shadow: 0px 4px 15px rgba(0,0,0,0.1); }
    h1 { text-align: center; color: #007BFF; margin-bottom: 30px; font-size: 28px; }
    h2 { color: #007BFF; margin-top: 20px; margin-bottom: 10px; font-size: 22px; }
    p { margin: 10px 0; }
